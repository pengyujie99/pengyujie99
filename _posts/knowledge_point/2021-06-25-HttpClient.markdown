...
![2](D:\Typora\Blog\pengyujie99.github.io\_posts\knowledge_point\2021-06-25-HttpClient.assets\2.png)
...
![3](D:\Typora\Blog\pengyujie99.github.io\_posts\knowledge_point\2021-06-25-HttpClient.assets\3.png)
...
~~~java
		HcPost payPost = new HcPostImpl();
        result = payPost.post("url", barcodepay,"access_token=xxx");

		HcPost payPost = new HcStreamPostImpl();
        result = payPost.post("url", barcodepay,"access_token=xxx");
~~~
